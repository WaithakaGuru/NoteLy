...
function MarkdownGuide() {
  return (
    <Box
      component={"div"}
      className="md:pl-10 pl-4 border border-gray-300 rounded-md shadow-xl md:max-h-48 overflow-auto mb-4"
    >
      <Paper className="p-4 flex flex-col " elevation={0}>
        <Markdown>### **Markdown Quick Guide**</Markdown>
        <Typography
          variant="body2"
        ...
        <Typography variant="body2" className="text-gray-600" gutterBottom>
          Use <strong>``` multiple_lines_of_code```</strong> for multiple lines
          of code
        </Typography>
        <Typography variant="body2" className="text-gray-600" gutterBottom>
