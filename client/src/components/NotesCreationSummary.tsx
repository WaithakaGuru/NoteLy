...
function NotesCreationSummary(notes: NoteType[]) {
    const summaryInfo = getNotesPerDuration(notes);
  return (
            ...
            >
              ...
              <Box>
                ...
                <Typography
                  ...
                  fontWeight={700}
                >
                  {summaryInfo.today? `${summaryInfo.today} Notes added today` : "No Notes added today"}
                </Typography>
              </Box>
            </Paper>
            <Paper
            ...
            >
              ...
              <Box>
                ...
                <Typography
                  ...
                  fontWeight={700}
                >
                    {summaryInfo.week? `${summaryInfo.week} Notes added this week` : "No Notes added this week"}
                </Typography>
              </Box>
            </Paper>
            <Paper
            ...
            >
              ...
              <Box>
                ...
                <Typography
                  ...
                  fontWeight={700}
                >
                    {summaryInfo.month? `${summaryInfo.month} Notes added this month` : "No Notes added this month"}
                </Typography>
              </Box>
            </Paper>
          </Stack>
