  ...
  return (  
    <>
        <Stack className="min-h-[90%] text-gray-800 flex flex-col 
         items-center justify-center p-6 pb-16" bgcolor={"#e7edf6ff"}
        >
        ...
        <Stack component="section" sx={{ px: { xs: 2, md: 6 }, py: 8, bgcolor:'transparent'}} id="about"
        >
        <Typography
            variant="h3"
            fontWeight="bold"
        ...
        <Grid container spacing={4} justifyContent="center">
            ...
            <Grid size={{xs:12, sm:6, md:3}} key={index}>
                ...
                sx={{
                    ...
                    textAlign: "center",
                    color: "#6D28D9",
                    background: "linear-gradient(45deg, #e7edf6ff, #c3cfe2)",
        ...
        >
            ...
            >
            <strong style={{ color: "#6D28D9" }}>Notely</strong> was born out of a simple need: a smarter, cleaner way to capture thoughts, ideas,
            and tasks—without the clutter. What started as a personal tool to stay organized soon grew into a
            passion project shared with friends, students, and busy professionals who wanted more than just
            another note-taking app.
            <br /><br />
            We believe in <span style={{ color: "#4338CA", fontWeight: 500 }}>simplicity, focus, and speed</span>. Whether you're jotting down
            a quick idea, organizing study notes, or planning your next big project, Notely is designed to help
            you think clearly and stay productive.
            <br /><br />
            Built with love by creators who understand the chaos of digital overload, Notely is here to bring
            <span style={{ color: "#6D28D9", fontWeight: 500 }}> clarity to your creativity</span>.
            </Typography>
        </Paper>
        </Stack>
    </>
