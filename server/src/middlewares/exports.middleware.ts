...
export {authenticateUsername, authenticateEmail, verifyIdentifier, verifyLoginPassword, 
    verifyCurrentPassword, verifyJWebToken, verifyUniqueEmail, verifyUniqueUsername
}